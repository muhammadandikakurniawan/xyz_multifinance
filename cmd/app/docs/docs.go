...
const docTemplate = `{
    {
        ...
        "definitions": {
          ...
          "RequestCreateNewConsumerDto": {
            ...
            "properties": {
              "date_of_birth": {
                "description": "The birth date for this consumer, ex : dd/mm/yyyy (29/12/1999)",
                "type": "string",
              ...
              "nik": {
                "description": "Unique identifier for this consumer, need ecrypted using aes cbc",
                "type": "string",
                "maximum": 20,
                "minimum": 16,
                "x-go-name": "NIK"
          ...
          "RequestLoanDto": {
            ...
            "properties": {
              ...
              "consumer_name": {
                "type": "string",
                "x-go-name": "ConsumerName"
              },
              "consumer_salary": {
                "type": "number",
                "format": "double",
                "x-go-name": "ConsumerSalary"
              },
              "contract_number": {
                "type": "string",
...
var SwaggerInfo = &swag.Spec{
	...
	BasePath:         "/",
	Schemes:          []string{"http"},
	Title:            "XYZ Multifinance APIs",
	Description:      "XYZ Multifinance api doc",
